...
list_of_files= [
    ...
    f"{project_name}/components/__int__.py",
    ...
    f"{project_name}/constants/__int__.py",
    f"{project_name}/entity/__int__.py",
    f"{project_name}/entity/config_entity.py",
    f"{project_name}/entity/artifact_entity.py",
    f"{project_name}/exception/__int__.py",
    f"{project_name}/logger/__int__.py",
    f"{project_name}/pipline/__int__.py",
    f"{project_name}/pipline/training_pipline.py",
